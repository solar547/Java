 ...
 * 查询页面以及查询内容显示
 */
public class CheckSwingStu extends JFrame {

    //根据从菜单的总表选择的行数的学号来寻找学生完整信息
    public CheckSwingStu(String id)  {
        setSize(300,650);
        ...
        //设置按钮
        JButton jbu1=new JButton("确认");
        jbu1.setBounds(50,520,80,30);
        add(jbu1);

        JButton jbu2=new JButton("返回");
        jbu2.setBounds(150,520,80,30);
        add(jbu2);
        ...
        jbu1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                MenuSwingStu return3 = new MenuSwingStu();
                return3.setBounds((ScreenUtils.getScreenWidth() - 450)/2,
                        (ScreenUtils.getScreenHeight() - 350)/2, 400, 300);
                return3.setResizable(true);
                return3.setTitle("管理系统");
                dispose();
            }
        });
